...
.post(authenticate.verifyUser, authenticate.verifyAdmin, upload.single('imageFile'), (req, res) => { //single func takes name of the form feild which specifies the file as parameter. After upload you file would have been successfully uploadedso handle it next
    res.statusCode = 200;
